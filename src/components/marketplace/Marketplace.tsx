    ...
    <div className="min-h-screen bg-black/95 text-white">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8 flex flex-wrap items-center gap-4">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full rounded-xl bg-black/40 px-10 py-2.5 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 border border-gray-800"
            />
          </div>
          
          <button
            onClick={() => setShowFilters(!showFilters)}
            className="flex items-center gap-2 rounded-xl bg-black/40 px-4 py-2.5 text-white hover:bg-black/60 transition-all duration-200 border border-gray-800"
          >
        ...
        <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
          <div className="rounded-xl bg-black/40 p-4 border border-gray-800">
